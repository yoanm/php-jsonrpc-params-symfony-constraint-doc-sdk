Feature: ConstraintToParamsDocTransformer - Cascade constraint

  Scenario: Simple Cascade constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Cascade();
    """
  ...
  Scenario: Fully configured Cascade constraint with string type specified
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Cascade([
