Feature: ConstraintToParamsDocTransformer - Valid constraint

  Scenario: Simple Valid constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Valid();
    """
  ...
  Scenario: Fully configured Valid constraint with string type specified
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Valid([
