Feature: ConstraintToParamsDocTransformer - Date constraint

  Scenario: Simple Date constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Date();
    """
  ...
  Scenario: Fully configured Date constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Date([
