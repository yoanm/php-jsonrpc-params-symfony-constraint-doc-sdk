Feature: ConstraintToParamsDocTransformer - Email constraint

  Scenario: Simple Email constraint
    ...
    And constraint doc "getFormat" should return the value "email"
  ...
  Scenario: Fully configured Email constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Email([
