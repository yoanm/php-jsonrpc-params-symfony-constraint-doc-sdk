Feature: ConstraintToParamsDocTransformer - Ulid constraint

  Scenario: Simple Ulid constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Ulid();
    """
    ...
    And constraint doc "getFormat" should return the value "ulid"
  ...
  Scenario: Fully configured Ulid constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Ulid([
