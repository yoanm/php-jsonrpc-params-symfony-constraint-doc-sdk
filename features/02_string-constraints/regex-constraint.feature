Feature: ConstraintToParamsDocTransformer - Regex constraint

  Scenario: Simple Regex constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Regex([
      'pattern' => '/.*/'
    ]);
    """
  ...
  Scenario: Simple Regex constraint on string Type
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Regex([
    ...
    And constraint doc "getFormat" should return the value "/.*/"
    ## Check others properties
    And constraint doc "getName" should return null
    And constraint doc "getDescription" should return null
    And constraint doc "getDefault" should return null
  ...
  Scenario: Fully configured Regex constraint on string Type
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Regex([
