Feature: ConstraintToParamsDocTransformer - Ip constraint

  Scenario: Simple Ip constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Ip();
    """
    ...
    And constraint doc "getFormat" should return the value "ip"
  ...
  Scenario: Fully configured Ip constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Ip([
