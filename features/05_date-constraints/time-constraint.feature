Feature: ConstraintToParamsDocTransformer - Time constraint

  Scenario: Simple Time constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Time();
    """
    ...
    And constraint doc "getFormat" should return the value "time"
  ...
  Scenario: Fully configured Time constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Time([
