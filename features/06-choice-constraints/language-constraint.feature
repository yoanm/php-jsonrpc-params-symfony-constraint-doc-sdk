Feature: ConstraintToParamsDocTransformer - Language constraints

  Scenario: Simple Language constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Language();
    """
    ...
    And constraint doc "getFormat" should return the value "language"
  ...
  Scenario: Fully configured Language constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Language([
