Feature: ConstraintToParamsDocTransformer - Country constraints

  Scenario: Simple Country constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Country();
    """
    ...
    And constraint doc "getFormat" should return the value "country"
  ...
  Scenario: Fully configured Country constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Country([
