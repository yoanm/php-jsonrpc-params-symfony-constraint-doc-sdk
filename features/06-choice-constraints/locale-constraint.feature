Feature: ConstraintToParamsDocTransformer - Locale constraints

  Scenario: Simple Locale constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Locale();
    """
    ...
    And constraint doc "getFormat" should return the value "locale"
  ...
  Scenario: Fully configured Locale constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Locale([
