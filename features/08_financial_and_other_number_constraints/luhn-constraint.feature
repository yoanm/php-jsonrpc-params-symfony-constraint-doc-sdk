Feature: ConstraintToParamsDocTransformer - Luhn constraint

  Scenario: Simple Luhn constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Luhn();
    """
    ...
    And constraint doc "getFormat" should return the value "luhn"
  ...
  Scenario: Fully configure Luhn constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Luhn([
