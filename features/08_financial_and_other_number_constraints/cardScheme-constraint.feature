Feature: ConstraintToParamsDocTransformer - CardScheme constraint

  Scenario: Simple CardScheme constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\CardScheme('AMEX');
    """
    ...
    And constraint doc "getFormat" should return the value "cardScheme"
  ...
  Scenario: Fully configured CardScheme constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\CardScheme([
      'schemes' => ['AMEX', 'DINERS'],
      'payload' => [
        'documentation' => [
