Feature: ConstraintToParamsDocTransformer - Bic constraint

  Scenario: Simple Bic constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Bic();
    """
    ...
    And constraint doc "getFormat" should return the value "bic"
  ...
  Scenario: Fully configured Bic constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Bic([
