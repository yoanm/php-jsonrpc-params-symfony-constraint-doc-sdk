Feature: ConstraintToParamsDocTransformer - Isin constraint

  Scenario: Simple Isin constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Isin();
    """
    ...
    And constraint doc "getFormat" should return the value "isin"
  ...
  Scenario: Fully configured Isin constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Isin([
