Feature: ConstraintToParamsDocTransformer - Isbn constraint

  Scenario: Simple Isbn constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Isbn();
    """
    ...
    And constraint doc "getFormat" should return the value "isbn"
  ...
  Scenario: Fully configured Isbn constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Isbn([
