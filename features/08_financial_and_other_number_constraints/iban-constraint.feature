Feature: ConstraintToParamsDocTransformer - Iban constraint

  Scenario: Simple Iban constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Iban();
    """
    ...
    And constraint doc "getFormat" should return the value "iban"
  ...
  Scenario: Fully configured Iban constraint
    Given I have the following Constraint:
    """
    use Symfony\Component\Validator\Constraints as ConstraintNS;
    return new ConstraintNS\Iban([
